...
def returnToLaunch(vehicle, height=30,land=True):
...
def gotoPoint(vehicle, targetLocation, accuracy=0.5, close=1.5):
...
def goto(vehicle, dNorth, dEast, accuracy=0.5, close=2):
    """
        Moves the vehicle to a position dNorth metres North and dEast metres East of the current position.
        By default it uses the standard method: dronekit.lib.Vehicle.simple_goto().
    ...
    gotoPoint(vehicle, targetLocation, accuracy, close)
